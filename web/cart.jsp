            ...
            <div class="container min-vh-100">
                ...
                <div class="row mt-3 w-100 mx-auto">
                    <div class="col-md-9 border border-2 rounded-1">
                                            ...
                                            <td style="vertical-align: middle; width: 150px">
                                                <div onchange="this.form.submit()" class="input-group quantity-input quantity-input-cart">
                                                    <button class="btn minus-btn" type="button" 
                                                            style="background-color: #662FB5; border-color: #662FB5; color: white;">-</button>
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <a class="btn" href="home"
                               style="color: #662FB5; border-color: #662FB5; background-color: transparent;"
                               onmouseover="this.style.backgroundColor='#662FB5'; this.style.color='#fff'" 
                               onmouseout="this.style.backgroundColor='transparent'; this.style.color='#662FB5'">
                                Tiếp tục mua hàng
                            </a>
                            
                            <a class="btn" href="DeleteAllCart"
                               style="color: #662FB5; border-color: #662FB5; background-color: transparent;"
                               onmouseover="this.style.backgroundColor='#662FB5'; this.style.color='#fff'" 
                               onmouseout="this.style.backgroundColor='transparent'; this.style.color='#662FB5'">
                                Xóa hết
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <a class="btn w-100" href="payment.jsp" 
                               style="background-color: #662FB5; border-color: #662FB5; color: white;">
