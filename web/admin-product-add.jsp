                        ...
                        <form action="AddNewProduct" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4 input-group mb-3">
                                    ...
                                    <!--RAM-->
                                    <input type="text" name="productRam" class="form-control" id="inputRam" placeholder="VD: 16" maxlength="4" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" required>
                                    <div class="input-group-append">
                                ...
                                <div class="col-md-4 input-group mb-3">
                                    ...
                                    <!--ROM-->
                                    <input type="text" class="form-control" name="productRom" id="inputRom" placeholder="VD: 512" maxlength="5" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text">GB</span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 input-group mb-3">
                                    ...
                                    <!--Kích thước màn hình-->
                                    <input type="text" class="form-control" name="productSize" placeholder="VD: 15.6" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');">
                                    <div class="input-group-append">
