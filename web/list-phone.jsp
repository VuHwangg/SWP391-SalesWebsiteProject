                        ...
                        <div class="sort-method row">
                            ...
                            <div class="col-md-8">
                                <div class="btn-group sort-method-selection" role="group">
                                    <a class="btn btn-outline-purple active" href="search?txtSearch=${param.txtSearch}&sort=none">
                                        Khuyến mãi
                                    </a>
                                    <a class="btn btn-outline-purple" href="search?txtSearch=${param.txtSearch}&sort=ASC">
                                        Giá tăng dần
                                    </a>
                                    <a class="btn btn-outline-purple" href="search?txtSearch=${param.txtSearch}&sort=DESC">
                                        Giá giảm dần
                                    </a>
                                </div>
                            </div>
